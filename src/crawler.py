...
class SettingsManager:
    ...
    def _get_tier_allowed_settings(self):
        ...
        user_settings = [
            ...
            # AutoSite tab
            'autosite_scan_id', 'autosite_project_id', 'autosite_webhook_url', 'autosite_service_role_key'
        ]
    ...
    def _get_default_settings(self):
        ...
        return {
            ...
            # AutoSite integration settings
            'autosite_scan_id': '',
            'autosite_project_id': '',
            'autosite_webhook_url': '',
            'autosite_service_role_key': '',
...
*.min.css'''
    ...
    def get_crawler_config(self):
        ...
        return {
            ...
            'autosite_scan_id': settings.get('autosite_scan_id', ''),
            'autosite_project_id': settings.get('autosite_project_id', ''),
            'autosite_webhook_url': settings.get('autosite_webhook_url', ''),
            'autosite_service_role_key': settings.get('autosite_service_role_key', '')
        }
